...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
    ...
    protected static Konfiguracija dajKonfiguraciju(String nazivDatoteke) throws NeispravnaKonfiguracija {
        ...
        switch (ekstenzija) {
            ...
            default:
                throw new NeispravnaKonfiguracija("Datoteka '" + nazivDatoteke + "' sa ekstenzijom '" + ekstenzija + "' nije podrĹľana!");
        }
    }

    private static String dajEkstenziju(String nazivDatoteke) {
